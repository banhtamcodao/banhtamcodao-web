...
const categoryImages: Record<string, string> = {
    'Tất cả': '/images/menu-icons/hero-dish_4.png', // Placeholder
...
export default function CategorySlider({ categories, activeCategory, onSelectCategory }: CategorySliderProps) {
    return (
                    ...
                    {categories.map((category) => (
                        <SwiperSlide key={category} className="!w-auto">
                            ...
                            >
                                ...
                                <div className={`relative w-12 h-12 md:w-18 md:h-18 rounded-full mb-2 overflow-hidden shadow-sm transition-transform duration-300 ${activeCategory === category ? 'scale-110' : 'group-hover:scale-110'
                                    }`}>
                                    <img
