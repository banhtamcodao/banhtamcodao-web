...
export default function Testimonials() {
    ...
    return (
        <section className="relative py-10 md:py-16 bg-[#FFFBF7] overflow-hidden" aria-label="Đánh giá khách hàng">
            ...
            <div className="max-w-[1200px] mx-auto px-4 relative z-10">
                ...
                <div className="max-w-[1200px] mx-auto">
                    <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-12 border border-gray-100">
                        ...
                        <button
                            onClick={prevReview}
                            className="cursor-pointer absolute top-1/2 -left-3 md:-left-12 -translate-y-1/2 w-8 h-8 md:w-12 md:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-primary hover:scale-110 transition-all duration-300 group"
                        ...
                        <button
                            onClick={nextReview}
                            className="cursor-pointer absolute top-1/2 -right-3 md:-right-12 -translate-y-1/2 w-8 h-8 md:w-12 md:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-primary hover:scale-110 transition-all duration-300 group"
                    ...
                    <div className="flex justify-center gap-2 mt-6 md:mt-8">
                        {reviews.map((_, index) => (
                            <button
                                ...
                                className={`cursor-pointer w-2 h-2 md:w-3 md:h-3 rounded-full transition-all duration-300 ${index === currentIndex ? 'bg-primary w-6 md:w-8' : 'bg-gray-300 hover:bg-primary/50'
                                    }`}
